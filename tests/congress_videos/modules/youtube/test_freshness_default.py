...
class TestGetVideoDetailsFunctionSignatureDefault:
    def test_min_hours_since_end_default_is_12(self):
        ...
        assert param.default == 12, f"min_hours_since_end default must be 12, got {param.default!r}"
    ...
    def test_video_ended_3h_ago_is_excluded_with_default(self):
        ...
        assert result["total_videos"] == 0, "Video ended 3h ago must be excluded with the 12h default"
    ...
    def test_video_ended_13h_ago_is_included_with_default(self):
        ...
        assert result["total_videos"] == 1, "Video ended 13h ago must be included with the 12h default"
    ...
    def test_custom_override_of_6_still_honored(self):
        ...
        assert result["total_videos"] == 1, "Video ended 7h ago must be included when min_hours_since_end=6"
...
class TestDAGFreshnessDefault:
    def test_dag_param_default_is_12(self):
        ...
        assert int(dag.params["min_hours_since_end"]) == 12, (
            f"DAG param min_hours_since_end must default to 12, got {dag.params['min_hours_since_end']!r}"
        )
