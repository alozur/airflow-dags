...
PROJECT_DATA_DIR = os.path.join(BASE_DATA_DIR, "congress_videos")
...
VIDEOS_DIR = os.path.join(PROJECT_DATA_DIR, "videos")

# -------------------------
# Assets Directories
# -------------------------
# Assets directory for thumbnail generation (images, logos, etc.)
ASSETS_DIR = os.path.join(PROJECT_DATA_DIR, "assets")
...
YOUTUBE_TOKEN_FILE = os.path.join(PROJECT_DATA_DIR, "congress_youtube_token.pickle")
...
BACKGROUND_IMAGE = os.path.join(ASSETS_DIR, "congress_chamber_background.png")
CHANNEL_LOGO = os.path.join(ASSETS_DIR, "congress_channel_logo.png")
...
def get_session_path(session_number: str) -> str:
    ...
    Returns:
        Full path to session directory (e.g., /opt/airflow/data/congreso_youtube/videos/PL_115_001)
    """
    return os.path.join(VIDEOS_DIR, str(session_number))
...
def get_topic_path(session_number: str, topic_entry_id: str) -> str:
    ...
    """
    return os.path.join(get_session_path(session_number), topic_entry_id)
...
def get_video_path(session_number: str, topic_entry_id: str, filename: str) -> str:
    ...
    """
    return os.path.join(get_topic_path(session_number, topic_entry_id), filename)
