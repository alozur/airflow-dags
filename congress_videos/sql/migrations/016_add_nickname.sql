...
--
-- Example (development): psql ... -c "SET search_path TO development, public;" -f 016_add_nickname.sql
-- Example (production):  psql ... -c "SET search_path TO production, public;"  -f 016_add_nickname.sql
