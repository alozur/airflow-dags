-- Grant permissions on development schema to 'airflow' user
-- Run this with a superuser account (e.g., postgres user)

-- Grant usage on schema
GRANT USAGE ON SCHEMA development TO airflow;

-- Grant all privileges on schema
GRANT ALL PRIVILEGES ON SCHEMA development TO airflow;

-- Grant all privileges on all existing tables
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA development TO airflow;

-- Grant all privileges on all sequences (for auto-increment columns)
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA development TO airflow;

-- Grant all privileges on all functions in schema
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA development TO airflow;
